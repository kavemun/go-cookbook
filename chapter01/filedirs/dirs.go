...
// Operate manipulates filesssss and directories
func Operate() error {
	// this 0777 is simlar to what you'd see with shown on a command line
	// this will create a directory /tmp/example, you may also use an
	...
	// we write a known length value to the file and validate that it wrote
	// correctly
	value := []byte("hello\n")
	...
	// cleanup, os.RemoveAll can be dangerous if you point at the wrong directory, use user input,
